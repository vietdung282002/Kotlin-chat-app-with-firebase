...
import com.example.chatapp.model.dataclass.Messages
import com.example.chatapp.model.dataclass.OtherUser
import com.example.chatapp.model.dataclass.RecentChats
import com.example.chatapp.model.dataclass.Users
import com.example.chatapp.model.repository.ChatListRepo
import com.example.chatapp.model.repository.MessageRepo
import com.example.chatapp.model.repository.UsersRepo
import com.example.chatapp.model.dataclass.NotificationData
import com.example.chatapp.model.dataclass.PushNotification
import com.example.chatapp.model.dataclass.Token
import com.example.chatapp.model.network.RetrofitInstance
...
class ChatAppViewModel : ViewModel() {
    ...
    //
    fun getUsers(friendList: ArrayList<String>?, friendRequested: ArrayList<String>?, friendRequests: ArrayList<String>?,
                    ...
                    firestore.collection("Tokens").document(receiver)
                        .addSnapshotListener { value, _ ->
                            if (value != null && value.exists()) {
                                ...
                                Log.d("vietdung282002", "sendMessage: ${(message.value!!.isNotEmpty()).toString()}")
                                Log.d("vietdung282002", "sendMessage: ${( receiver.isNotEmpty()).toString()}")
                                Log.d("vietdung282002", "sendMessage: ${(tokenObject != null).toString()}")
...
//                        message.value = ""
    ...
    private fun sendNotification(notification: PushNotification) = viewModelScope.launch {
        try {
            Log.d("vietdung282002", "sendNotification: ")
